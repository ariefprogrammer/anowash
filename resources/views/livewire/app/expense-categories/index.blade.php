<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold">Kategori Pengeluaran</h1>
            ...
            <tbody class="divide-y">
                @forelse($categories as $category)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-gray-600">{{ $category->expenses_count }}</td>
                        <td class="px-4 py-3">
        ...
        @forelse($categories as $category)
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="text-xs text-gray-400 space-y-1 mb-3">
                    <p><i class="fa-solid fa-receipt w-4"></i> {{ $category->expenses_count }} transaksi</p>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                ...
                <form wire:submit="save" class="space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model="name" class="w-full border rounded px-3 py-2" placeholder="misal: Internet, Listrik, Sewa">
